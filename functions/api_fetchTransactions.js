exports = async function(apiKey){
  ...
  for (const rawTransaction of rawTransactions) {
    ...
    if (finalTransaction.merchantId) {
      var merchant = await context.functions.execute("utils_getMerchantById", finalTransaction.merchantId);
      finalTransaction.merchant = merchant;
    }
